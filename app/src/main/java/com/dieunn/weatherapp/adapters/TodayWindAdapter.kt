...
class TodayWindAdapter(private val context: Context, private val dataList: List<Hourly>) :
    RecyclerView.Adapter<TodayWindAdapter.ViewHolder>() {
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            todayWindItemIcon =
                itemView.findViewById<ImageView>(R.id.today_weather_wind_item_icon)
            todayWindItemSpeed =
                itemView.findViewById<TextView>(R.id.today_weather_wind_item_wind_speed)
            todayWindItemTime =
                itemView.findViewById<TextView>(R.id.today_weather_wind_item_time)
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(context).inflate(R.layout.today_weather_wind_item, parent, false)
        )
    }
